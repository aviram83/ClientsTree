  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside mb-4">
        <li><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named ClientsTree.</li>
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ClientsTree.</li>
      ...
      <p className="mb-4">The owner of this application, Aviram Salamon, takes no responsibility for any data loss or any other damages that did not occur with vicious intention. To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be liable for any special, incidental, indirect, or consequential damages whatsoever (including, but not limited to, damages for loss of profits, for loss of data or other information, for business interruption, for personal injury, for loss of privacy arising out of or in any way related to the use of or inability to use the Service, third-party software and/or third-party hardware used with the Service, or otherwise in connection with any provision of this Terms), even if the Company or any supplier has been advised of the possibility of such damages and even if the remedy fails of its essential purpose.</p>
      
      <h2 className="text-2xl font-bold mb-2">Changes to These Terms and Conditions</h2>
      ...
      <ul className="list-disc list-inside">
        <li>By email: aviram83@gmail.com</li>
      </ul>
    </div>
  );
};
