  ...
  return (
    <div className="absolute top-4 right-4 z-50">
      <div className="flex flex-col items-end">
        ...
        <div 
          className={`
            bg-card shadow-lg border border-border transition-all duration-300 flex items-center overflow-hidden
        ...
        >
          <div className={`flex-1 overflow-hidden transition-all duration-300 ${isOpen ? 'opacity-100 px-3' : 'opacity-0 w-0'}`}>
            <h3 className="font-bold text-foreground whitespace-nowrap text-sm text-right">מקרא</h3>
          </div>
          <div className="flex-shrink-0">
            <button
              ...
              className={`
                ...
                ${isOpen ? 'text-primary bg-primary/10' : 'text-muted-foreground hover:bg-accent'}
              `}
        ...
        <div className={`bg-card shadow-lg border border-border border-t-0 rounded-b-2xl overflow-hidden transition-all duration-300 w-48 ${isOpen ? 'max-h-64 p-4 opacity-100' : 'max-h-0 p-0 opacity-0 border-0'}`}>
